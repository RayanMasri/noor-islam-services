...
!(function (t) {
	...
	function (t, e, n) {
		...
		(e.MODULO = 103),
			...
			(e.C_CHARS = '(Ï*[0-9]{2}Ï*)'),
			(e.BARS = [
				11011001100, 11001101100, 11001100110, 10010011e3, 10010001100, 10001001100, 10011001e3, 10011000100, 10001100100, 11001001e3, 11001000100, 11000100100, 10110011100, 10011011100,
				10011001110, 10111001100, 10011101100, 10011100110, 11001110010, 11001011100, 11001001110, 11011100100, 11001110100, 11101101110, 11101001100, 11100101100, 11100100110, 11101100100,
				11100110100, 11100110010, 11011011e3, 11011000110, 11000110110, 10100011e3, 10001011e3, 10001000110, 10110001e3, 10001101e3, 10001100010, 11010001e3, 11000101e3, 11000100010,
				10110111e3, 10110001110, 10001101110, 10111011e3, 10111000110, 10001110110, 11101110110, 11010001110, 11000101110, 11011101e3, 11011100010, 11011101110, 11101011e3, 11101000110,
				11100010110, 11101101e3, 11101100010, 11100011010, 11101111010, 11001000010, 11110001010, 1010011e4, 10100001100, 1001011e4, 10010000110, 10000101100, 10000100110, 1011001e4,
				10110000100, 1001101e4, 10011000010, 10000110100, 10000110010, 11000010010, 1100101e4, 11110111010, 11000010100, 10001111010, 10100111100, 10010111100, 10010011110, 10111100100,
				10011110100, 10011110010, 11110100100, 11110010100, 11110010010, 11011011110, 11011110110, 11110110110, 10101111e3, 10100011110, 10001011110, 10111101e3, 10111100010, 11110101e3,
				11110100010, 10111011110, 10111101110, 11101011110, 11110101110, 11010000100, 1101001e4, 11010011100, 1100011101011,
			]);
	},
	function (t, e, n) {
		'use strict';
						...
						},
						{
							...
							value: function () {
								...
								return {
									...
									data: e.getBar(n) + o.result + e.getBar((o.checksum + n) % u.MODULO) + e.getBar(u.STOP),
								};
							},
						},
						{
					...
					[
						...
						},
						{
							...
							value: function (t, e) {
								...
								return e === u.SET_B ? t.shift() - 32 : 10 * (t.shift() - 48) + t.shift() - 48;
							},
						},
						{
							key: 'next',
							value: function (t, n, r) {
								...
								if (t[0] >= 200) {
									...
									void 0 !== a
										? (o = e.next(t, n + 1, a))
										: ((r !== u.SET_A && r !== u.SET_B) || i !== u.SHIFT || (t[0] = r === u.SET_A ? (t[0] > 95 ? t[0] - 96 : t[0]) : t[0] < 32 ? t[0] + 96 : t[0]),
										  (o = e.next(t, n + 1, r)));
			...
			return (
				...
				r(e, [
					...
					},
					{
						key: 'encodeFlat',
						value: function () {
							return { data: [o.SIDE_BIN, this.leftEncode(), o.MIDDLE_BIN, this.rightEncode(), o.SIDE_BIN].join(''), text: this.text };
						},
					},
				]),
				e
				...
				r(e, [
					...
					},
					{
						...
						value: function () {
							var t = [];
							return (
								this.displayValue && t.push({ data: '00000000', text: this.text.substr(0, 1), options: { textAlign: 'left', fontSize: this.fontSize } }),
								t.push({ data: '101' + (0, o.default)(this.data[0], 'L'), options: { height: this.guardHeight } }),
								t.push({ data: (0, o.default)(this.data.substr(1, 5), 'LLLLL'), text: this.text.substr(1, 5), options: { fontSize: this.fontSize } }),
								t.push({ data: '01010', options: { height: this.guardHeight } }),
								t.push({ data: (0, o.default)(this.data.substr(6, 5), 'RRRRR'), text: this.text.substr(6, 5), options: { fontSize: this.fontSize } }),
								t.push({ data: (0, o.default)(this.data[11], 'R') + '101', options: { height: this.guardHeight } }),
								this.displayValue && t.push({ data: '00000000', text: this.text.substr(11, 1), options: { textAlign: 'right', fontSize: this.fontSize } }),
								t
							);
						},
					},
	...
	function (t, e, n) {
		...
		var c = (function (t) {
			function e() {
				return u(this, e), f(this, (e.__proto__ || Object.getPrototypeOf(e)).apply(this, arguments));
			}
			return (
				(function (t, e) {
					if ('function' != typeof e && null !== e) throw new TypeError('Super expression must either be null or a function, not ' + typeof e);
		...
		(e.getMaximumHeightOfEncodings = function (t) {
			...
			(e.calculateEncodingAttributes = function (t, e, n) {
				for (var r = 0; r < t.length; r++) {
					...
					(c.width = Math.ceil(Math.max(o, l))), (c.height = a(c, s)), (c.barcodePadding = u(o, l, s));
				}
			}),
	...
	function (t, e, n) {
		...
		var d = function () {},
			h = function (t, e, n) {
				...
				return (
					...
					void 0 !== e && ((n = n || {}).format || (n.format = _()), r.options(n)[n.format](e, n).render()),
					r
				);
			};
		...
		(d.prototype.options = function (t) {
			...
			(d.prototype.render = function () {
				...
				if (Array.isArray(this._renderProperties)) for (var t = 0; t < this._renderProperties.length; t++) g(this._renderProperties[t], this._encodings, this._options);
	...
	function (t, e, n) {
		...
		var a = (function (t) {
			...
			f = [
				20957, 29783, 23639, 30485, 20951, 29813, 23669, 20855, 29789, 23645, 29975, 23831, 30533, 22295, 30149, 24005, 21623, 29981, 23837, 22301, 30023, 23879, 30545, 22343, 30161, 24017,
				21959, 30065, 23921, 22385, 29015, 18263, 29141, 17879, 29045, 18293, 17783, 29021, 18269, 17477, 17489, 17681, 20753, 35770,
			];
		function c(t) {
			return (function (t) {
		...
		var u = (function (t) {
			function e(t, n) {
				if (
					...
					var r = a(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, (0, o.default)(t), n));
	...
	function (t, e, n) {
		...
		(e.EAN13 = r.default), (e.EAN8 = o.default), (e.EAN5 = i.default), (e.EAN2 = a.default), (e.UPC = u.default), (e.UPCE = f.default);
	},
	function (t, e, n) {
		'use strict';
		Object.defineProperty(e, '__esModule', { value: !0 });
				...
				return (
					...
					o(e, [
						...
						},
						{
							key: 'leftText',
							value: function () {
								return i(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'leftText', this).call(this, 1, 6);
							},
						},
						{
							key: 'leftEncode',
							value: function () {
								...
								return i(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'leftEncode', this).call(this, t, n);
							},
						},
						{
							key: 'rightText',
							value: function () {
								return i(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'rightText', this).call(this, 7, 6);
							},
						},
						{
							key: 'rightEncode',
							value: function () {
								...
								return i(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'rightEncode', this).call(this, t, 'RRRRRR');
							},
						},
						{
							key: 'encodeGuarded',
							value: function () {
								var t = i(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'encodeGuarded', this).call(this);
								return (
									this.options.displayValue &&
										(t.unshift({ data: '000000000000', text: this.text.substr(0, 1), options: { textAlign: 'left', fontSize: this.fontSize } }),
										this.options.lastChar && (t.push({ data: '00' }), t.push({ data: '00000', text: this.options.lastChar, options: { fontSize: this.fontSize } }))),
									t
								);
							},
						},
					...
					o(e, [
						{
							key: 'valid',
							value: function () {
								return -1 !== this.data.search(/^[0-9]{8}$/) && +this.data[7] === f(this.data);
							},
						},
						{
							key: 'leftText',
							value: function () {
								return i(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'leftText', this).call(this, 0, 4);
							},
						},
						{
							key: 'leftEncode',
							value: function () {
								...
								return i(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'leftEncode', this).call(this, t, 'LLLL');
							},
						},
						{
							key: 'rightText',
							value: function () {
								return i(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'rightText', this).call(this, 4, 4);
							},
						},
						{
							key: 'rightEncode',
							value: function () {
								...
								return i(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'rightEncode', this).call(this, t, 'RRRR');
							},
						},
					]),
					e
				...
				r(e, [
					...
					},
					{
						...
						value: function () {
							...
							return { data: '1011' + (0, i.default)(this.data, e, '01'), text: this.text };
						},
					},
				]),
				e
				...
				r(e, [
					...
					},
					{
						...
						value: function () {
							...
							return { data: '1011' + (0, i.default)(this.data, t, '01'), text: this.text };
						},
					},
				]),
				e
	...
	function (t, e, n) {
			...
			l = (function (t) {
				function e(t, n) {
					...
					if (((r.isValid = !1), -1 !== t.search(/^[0-9]{6}$/)))
						(r.middleDigits = t), (r.upcA = p(t, '0')), (r.text = n.text || '' + r.upcA[0] + t + r.upcA[r.upcA.length - 1]), (r.isValid = !0);
					else {
						if (-1 === t.search(/^[01][0-9]{7}$/)) return f(r);
						if (((r.middleDigits = t.substring(1, t.length - 1)), (r.upcA = p(r.middleDigits, t[0])), r.upcA[r.upcA.length - 1] !== t[t.length - 1])) return f(r);
						r.isValid = !0;
					}
					return (
						(r.displayValue = n.displayValue),
				...
				return (
					...
					r(e, [
						...
						},
						{
							...
							value: function () {
								var t = '';
								return (t += '101'), (t += this.encodeMiddleDigits()), { data: (t += '010101'), text: this.text };
							},
						},
						{
							key: 'guardedEncoding',
							value: function () {
								var t = [];
								return (
									this.displayValue && t.push({ data: '00000000', text: this.text[0], options: { textAlign: 'left', fontSize: this.fontSize } }),
									t.push({ data: '101', options: { height: this.guardHeight } }),
									t.push({ data: this.encodeMiddleDigits(), text: this.text.substring(1, 7), options: { fontSize: this.fontSize } }),
									t.push({ data: '010101', options: { height: this.guardHeight } }),
									this.displayValue && t.push({ data: '00000000', text: this.text[7], options: { textAlign: 'right', fontSize: this.fontSize } }),
									t
								);
							},
						},
		...
		function p(t, e) {
			for (var n = parseInt(t[t.length - 1]), r = c[n], o = '', i = 0, u = 0; u < r.length; u++) {
				var f = r[u];
				o += 'X' === f ? t[i++] : f;
			}
	...
	function (t, e, n) {
		...
		(e.MSI = r.default), (e.MSI10 = o.default), (e.MSI11 = i.default), (e.MSI1010 = a.default), (e.MSI1110 = u.default);
	},
	function (t, e, n) {
		'use strict';
		Object.defineProperty(e, '__esModule', { value: !0 });
			...
			function e(t, n) {
				return (
					...
					(function (t, e) {
						if (!t) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
						return !e || ('object' != typeof e && 'function' != typeof e) ? t : e;
					})(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t + (0, a.mod10)(t), n))
				);
			}
			return (
				(function (t, e) {
			...
			function e(t, n) {
				return (
					...
					(function (t, e) {
						if (!t) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
						return !e || ('object' != typeof e && 'function' != typeof e) ? t : e;
					})(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t + (0, a.mod11)(t), n))
				);
			}
			return (
				(function (t, e) {
	...
	function (t, e, n) {
		...
		Object.defineProperty(e, '__esModule', { value: !0 }),
			(e.default = function (t) {
				return (
					(t.marginTop = t.marginTop || t.margin), (t.marginBottom = t.marginBottom || t.margin), (t.marginRight = t.marginRight || t.margin), (t.marginLeft = t.marginLeft || t.margin), t
				);
			});
	},
	function (t, e, n) {
		...
		function f(t) {
			...
			if ('undefined' != typeof HTMLCanvasElement && t instanceof HTMLCanvasElement) return { element: t, options: (0, o.default)(t), renderer: i.default.CanvasRenderer };
			if (t && t.getContext) return { element: t, renderer: i.default.CanvasRenderer };
			if (t && 'object' === (void 0 === t ? 'undefined' : r(t)) && !t.nodeName) return { element: t, renderer: i.default.ObjectRenderer };
		...
		e.default = function (t) {
			...
			for (var n in o.default)
				o.default.hasOwnProperty(n) &&
					(t.hasAttribute('jsbarcode-' + n.toLowerCase()) && (e[n] = t.getAttribute('jsbarcode-' + n.toLowerCase())),
					t.hasAttribute('data-' + n.toLowerCase()) && (e[n] = t.getAttribute('data-' + n.toLowerCase())));
				...
				o(t, [
					...
					},
					{
						...
						value: function (t, e) {
							...
							t.displayValue &&
								((r = 'top' == t.textPosition ? t.marginTop + t.fontSize - t.textMargin : t.height + t.textMargin + t.marginTop + t.fontSize),
								(o.font = i),
						...
						},
						{
							...
							value: function (t, e, n) {
								...
								for (var i = 0, a = 0, u = 0; u < o.length; u++)
									(a = u * e.width + n.barcodePadding), '1' === o[u] ? i++ : i > 0 && (this.drawRect(a - e.width * i, r, e.width * i, e.height, t), (i = 0));
